...
//    public Item createItemFromGender (@PathVariable Long seasonsId, @RequestBody Item itemObject) {
//        LOGGER.info("calling createItemFromGender from GenderController");
//        return seasonsService.createItemFromGender(seasonsId, itemObject);
//    }
